...
while True:
    ...
    if savings_needed < cost_of_down_payment - tolerance and months_limit == 36:
        r = None

print(f"Steps taken: {steps}")
print(f"Minimum rate of return needed: {r:.4f}" if r is not None else "Cannot achieve savings goal")
